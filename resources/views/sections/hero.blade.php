<section class="relative min-h-[90vh] flex items-center overflow-hidden">
    ...
    <!-- 🌾 Konten -->
    <div class="relative z-20 max-w-7xl mt-8 mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-gray-900">
        <!-- 🧬 Kiri: Teks & Form -->
        <div class="bg-white/20 backdrop-blur-lg border border-white/40 rounded-3xl shadow-2xl p-8 sm:p-10 text-center lg:text-left">
            ...
            <form action="#" method="GET" class="mt-8">
                <div class="relative max-w-lg mx-auto lg:mx-0">
                    <input type="text"
                        ...
                        class="w-full rounded-3xl border border-white/50 bg-white/40 backdrop-blur-md py-3 pl-5 pr-12 text-gray-800 placeholder-gray-600 shadow-inner focus:outline-none focus:ring-2 focus:ring-gray-900/30 transition">
                    <button type="submit"
                        class="absolute right-2 top-1/2 -translate-y-1/2 bg-gray-900 text-white rounded-3xl p-2.5 hover:bg-gray-800 transition">
            ...
            <div class="mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <a href="{{ route('katalog') }}" 
                    class="rounded-lg bg-gray-900/90 px-6 py-3 text-sm font-semibold text-white shadow-lg hover:bg-gray-800 transition-all duration-300 backdrop-blur-md">
                    Lihat Katalog
                </a>
                <a href="#"
        ...
        <!-- Kolom kanan dikosongkan supaya gambar tetap dominan -->
